...
html_theme_options = {
    "light_css_variables": {
        "font-stack": "Signika pysorteddict, Cochineal, system-ui, sans-serif, Apple Color Emoji, Segoe UI Emoji",
        "font-stack--headings": "Signika pysorteddict, Cochineal, system-ui, sans-serif, Apple Color Emoji, Segoe UI Emoji",
